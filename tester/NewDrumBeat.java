 ...
 * @author Andrew Brown
 */
public abstract class NewDrumBeat implements JMC {

    public NewDrumBeat() {
    }

    /** Name of the drum beat. Will be used as a filename when saving */
    ...
    /** Convenience fields for use in the compose methods of subclasses */
