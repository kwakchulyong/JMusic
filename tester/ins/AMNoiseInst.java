...
public final class AMNoiseInst extends jm.audio.Instrument {
    ...
    public void createChain() {
        ...
        Envelope modEnv = new Envelope(noise, new double[] { 0.0, 0.0, 0.5, 1.0, 1.0, 1.0 });
        ...
        // carrier
        Oscillator carrier = new Oscillator(add, Oscillator.SINE_WAVE, WaveTable.AMPLITUDE);
        Envelope env = new Envelope(carrier, new double[] { 0.0, 0.0, 0.5, 1.0, 1.0, 0.0 });
